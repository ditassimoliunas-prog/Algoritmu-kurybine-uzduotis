...
add.newface ([[-0.75, 0.75, -0.675], [-0.75, 0.75, 0.675], [-0.12, 1.375, 0.675], [-0.12, 1.375, -0.675]], [203, 218, 245])  # Front glass
...
# Frunk
add.newface ([[-0.75, 0.75, 0.675], [-0.75, 0.75, -0.675], [-1.4, 0.6, -0.675], [-1.4, 0.6, 0.675]], [107, 112, 121]) #Frunk lid
add.rectangle3D([-1.075, 0.55, 0], [0.675, 0.1, 1.343], [255, 255, 255]) #frunk body
...
# Rear left wheel
add.cylinder([-0.375, 0, -0.405], [-0.375, 0, -0.81], wheel_radius, wheel_detail, [50, 50, 50])
...
# Headlight
#add.rectangle3D([-0.675, 0.55, 0], [0.375, 0.1, 1.343], [255, 255, 255])
# Taillight
add.rectangle3D([0.675, 0.7125, 0], [0.375, 0.05, 1.343], [255, 50, 50])
add.rectangle3D([0.675, 0.7375, 0], [0.375, 0.05, 1.343], [0, 0, 0])
add.rectangle3D([0.675, 0.675, 0], [0.375, 0.1, 1.343], [0, 0, 0])
add.rectangle3D([0.675, 0.325, 0], [0.375, 0.65, 1.343], [107, 112, 121])

#Trunk
add.newface ([[0.798, 0.75, 0.675], [0.798, 0.75, -0.675], [0.198, 1.25, -0.675], [0.198, 1.25, 0.675]], [46,48,52])  # Trunk back face
add.newface ([[-0.12, 1.375, -0.675], [-0.12, 1.375, 0.675], [0.198, 1.25, 0.675], [0.198, 1.25, -0.675]], [46,48,52])  # Trunk back face extension
add.newface ([[0.198, 0.75, -0.675], [0.198, 1.25, -0.675], [0.798, 0.75, -0.675]], [107, 112, 121]) #Trunk right side
add.newface ([[0.798, 0.75, 0.675], [0.198, 1.25, 0.675], [0.198, 0.75, 0.675]], [107, 112, 121]) #Trunk left side
